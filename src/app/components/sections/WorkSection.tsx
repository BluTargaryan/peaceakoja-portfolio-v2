          ...
          >
            ...
            {worksData.map((work, i) => (
              <div
                ...
                className={`w-40 cursor-pointer h-56 border-3 shrink-0 snap-center transition-all duration-300 ${currentWork === work.name ? "border-accent p-2.5 scale-110" : "border-text scale-90"}
                md:w-40 md:h-56
                  `}
              >
